<template>
  <div class="auth">
    <div class="tabs is-centered">
      <ul>
        <li :class="{ 'is-active': !register }"><a
            @click.prevent="register = false">Login</a></li>
        <li :class="{ 'is-active': register }"><a
            @click.prevent="register = true">Register</a></li>
      </ul>
    </div>
        ...
        <form @submit.prevent="onSubmit">
          <div class="content">
            ...
            <div class="field">
              ...
              <div class="control">
                <input v-model="credentials.password" class="input"
